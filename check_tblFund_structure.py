...
DB_CONFIG = {
    "host": os.getenv("POSTGRES_PLATFORM_HOST") or os.getenv("POSTGRES_HOST", "gzcdevserver.postgres.database.azure.com"),
    "database": os.getenv("POSTGRES_PLATFORM_DB") or os.getenv("POSTGRES_DB", "gzc_platform"),
    "user": os.getenv("POSTGRES_PLATFORM_USER") or os.getenv("POSTGRES_USER", "mikael"),
    "password": os.getenv("POSTGRES_PLATFORM_PASSWORD") or os.getenv("POSTGRES_PASSWORD", "Ii89rra137+*"),
