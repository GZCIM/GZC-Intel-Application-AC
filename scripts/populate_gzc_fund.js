    ...
    try {
        ...
        await client.query(
            'INSERT INTO public.gzc_fund ("Id","FundNameShort","FundNameFull","mod_user","mod_timestamp") ' +
                'SELECT "FundId","FundNameShort","FundNameFull", $1, NOW() FROM leg."tblFund" WHERE "FundId" IN (1,6) ' +
        ...
        const res = await client.query(
            'SELECT "Id","FundNameShort","FundNameFull","mod_user","mod_timestamp" FROM public.gzc_fund WHERE "Id" IN (1,6) ORDER BY "Id"'
        );
