    ...
    useEffect(() => {
        ...
        const onNotionalUpdated = (e: Event) => {
            ...
            if ((id || (window as any)?.componentId || "default") === detail.componentId) {
                ...
                if (typeof detail.showFX === "boolean") setNotionalShowFX(!!detail.showFX);
                if (typeof detail.showFXOptions === "boolean") setNotionalShowFXOptions(!!detail.showFXOptions);
                            ...
                            >
                                ...
                                {notionalPlacement === "above" && notionalPositions.length > 0 && (
                                    <div style={{ marginBottom: 8 }}>
                                        <PortfolioNotionalTable selectedDate={effectiveDate} fundId={selectedFundId ?? 0} showFX={notionalShowFX} showFXOptions={notionalShowFXOptions} showTotal={notionalShowTotal} theme={currentTheme as any} />
                                    </div>
                                )}
                                <div
                                    style={{
