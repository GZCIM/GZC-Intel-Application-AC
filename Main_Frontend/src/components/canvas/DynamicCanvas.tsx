                        ...
                        {isThumb ? (
                            <div
                                ...
                                style={{
                                    ...
                                    borderRadius: "4px",
                                    display: "flex",
                                    flexDirection: isMobilePortrait
                                        ? "column"
                                        : "row",
                                    alignItems: isMobilePortrait
                                        ? "stretch"
                                        : "center",
                            ...
                            >
                                ...
                                >
                                    {/* Component state controls have been moved to ComponentHeaderWrapper */}
                                </div>

                                {/* Legacy controls removed - now using ComponentHeaderWrapper */}
                            </div>
                        ) : (
                            <>
