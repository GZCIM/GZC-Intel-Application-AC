            ...
            >
                ...
                <div
                    style={{
                        ...
                        fontWeight: 700,
                        background:
                            "linear-gradient(135deg, #95BD78 0%, #ABD38F 100%)",
                    ...
                    <div style={{ marginBottom: "12px" }}>
                        ...
                        <div style={{ display: "flex", gap: "8px" }}>
                            ...
                            <button
                                ...
                                style={{
                                    padding: "4px 12px",
                                    backgroundColor: layoutName.trim()
                                        ? quantumTheme.accent
                                        : "transparent",
                                    border: `1px solid ${
                                        layoutName.trim()
                                    ...
                                    borderRadius: "4px",
                                    color: layoutName.trim()
                                        ? "#000"
                                        : quantumTheme.textSecondary,
                                    fontSize: "12px",
                                    cursor: layoutName.trim()
                                        ? "pointer"
                                        : "not-allowed",
                                }}
                            >
